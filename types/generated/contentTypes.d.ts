...
export interface ApiGameGame extends Schema.CollectionType {
  ...
  attributes: {
    plannedDate: Attribute.DateTime;
    startDate: Attribute.DateTime;
    endDate: Attribute.DateTime;
    gameID: Attribute.UID;
    result: Attribute.Relation<
      'api::game.game',
      'oneToOne',
      'api::result.result'
    >;
    teams: Attribute.Relation<'api::game.game', 'manyToMany', 'api::team.team'>;
    venue: Attribute.Relation<'api::game.game', 'oneToOne', 'api::venue.venue'>;
    createdAt: Attribute.DateTime;
    updatedAt: Attribute.DateTime;
...
export interface ApiRegulationRegulation extends Schema.SingleType {
...
export interface ApiResultResult extends Schema.CollectionType {
  ...
  attributes: {
    score1: Attribute.Integer;
    score2: Attribute.Integer;
    team1: Attribute.Relation<
      'api::result.result',
      'oneToOne',
      'api::team.team'
    >;
    team2: Attribute.Relation<
      'api::result.result',
      'oneToOne',
      'api::team.team'
    >;
...
export interface ApiTeamTeam extends Schema.CollectionType {
  ...
  attributes: {
    name: Attribute.String;
    games: Attribute.Relation<'api::team.team', 'manyToMany', 'api::game.game'>;
    createdAt: Attribute.DateTime;
    updatedAt: Attribute.DateTime;
    publishedAt: Attribute.DateTime;
